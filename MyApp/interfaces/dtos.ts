...
// @Route("/about")
export class AppRoute0Request
{

    public constructor(init?: Partial<AppRoute0Request>) { (Object as any).assign(this, init); }
}

// @Route("/users/{id*}")
export class AppRoute1Request
{
    public id?: string;

    public constructor(init?: Partial<AppRoute1Request>) { (Object as any).assign(this, init); }
}

// @Route("/users/{id}")
export class AppRoute2Request
{
    public id?: string;

    public constructor(init?: Partial<AppRoute2Request>) { (Object as any).assign(this, init); }
}

// @Route("/users/create")
export class AppRoute3Request
{

    public constructor(init?: Partial<AppRoute3Request>) { (Object as any).assign(this, init); }
}

// @Route("/404")
export class AppRoute4Request
{

    public constructor(init?: Partial<AppRoute4Request>) { (Object as any).assign(this, init); }
}
